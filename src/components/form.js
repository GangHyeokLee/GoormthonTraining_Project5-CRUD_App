...
export default function Form({ handleSubmit, handleSubmitEdit, value, setValue, cost, setCost, isEditing, setIsEditing, editTargetId, setEditTargetId, budget }) {
    ...
    if (isEditing) {
        return (
            <div className="w-full">
                <form onSubmit={handleSubmitEdit} className="flex pt-2 flex-col">
